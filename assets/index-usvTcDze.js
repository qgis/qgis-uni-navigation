 ...
 */const ye=rt(class extends nt{constructor(n){var e;if(super(n),n.type!==it.ATTRIBUTE||n.name!=="class"||((e=n.strings)==null?void 0:e.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(n){return" "+Object.keys(n).filter(e=>n[e]).join(" ")+" "}update(n,[e]){var i,r;if(this.it===void 0){this.it=new Set,n.strings!==void 0&&(this.st=new Set(n.strings.join(" ").split(/\s/).filter(s=>s!=="")));for(const s in e)e[s]&&!((i=this.st)!=null&&i.has(s))&&this.it.add(s);return this.render(e)}const t=n.element.classList;for(const s of this.it)s in e||(t.remove(s),this.it.delete(s));for(const s in e){const o=!!e[s];o===this.it.has(s)||(r=this.st)!=null&&r.has(s)||(o?(t.add(s),this.it.add(s)):(t.remove(s),this.it.delete(s)))}return T}});function st(n){for(var e=[],t=0;t<n.length;){var i=n[t];if(i==="*"||i==="+"||i==="?"){e.push({type:"MODIFIER",index:t,value:n[t++]});continue}if(i==="\\"){e.push({type:"ESCAPED_CHAR",index:t++,value:n[t++]});continue}if(i==="{"){e.push({type:"OPEN",index:t,value:n[t++]});continue}if(i==="}"){e.push({type:"CLOSE",index:t,value:n[t++]});continue}if(i===":"){for(var r="",s=t+1;s<n.length;){var o=n.charCodeAt(s);if(o>=48&&o<=57||o>=65&&o<=90||o>=97&&o<=122||o===95){r+=n[s++];continue}break}if(!r)throw new TypeError("Missing parameter name at ".concat(t));e.push({type:"NAME",index:t,value:r}),t=s;continue}if(i==="("){var l=1,a="",s=t+1;if(n[s]==="?")throw new TypeError('Pattern cannot start with "?" at '.concat(s));for(;s<n.length;){if(n[s]==="\\"){a+=n[s++]+n[s++];continue}if(n[s]===")"){if(l--,l===0){s++;break}}else if(n[s]==="("&&(l++,n[s+1]!=="?"))throw new TypeError("Capturing groups are not allowed at ".concat(s));a+=n[s++]}if(l)throw new TypeError("Unbalanced pattern at ".concat(t));if(!a)throw new TypeError("Missing pattern at ".concat(t));e.push({type:"PATTERN",index:t,value:a}),t=s;continue}e.push({type:"CHAR",index:t,value:n[t++]})}return e.push({type:"END",index:t,value:""}),e}function ot(n,e){e===void 0&&(e={});for(var t=st(n),i=e.prefixes,r=i===void 0?"./":i,s="[^".concat(M(e.delimiter||"/#?"),"]+?"),o=[],l=0,a=0,h="",c=function(v){if(a<t.length&&t[a].type===v)return t[a++].value},d=function(v){var x=c(v);if(x!==void 0)return x;var E=t[a],G=E.type,Q=E.index;throw new TypeError("Unexpected ".concat(G," at ").concat(Q,", expected ").concat(v))},f=function(){for(var v="",x;x=c("CHAR")||c("ESCAPED_CHAR");)v+=x;return v};a<t.length;){var p=c("CHAR"),$=c("NAME"),k=c("PATTERN");if($||k){var b=p||"";r.indexOf(b)===-1&&(h+=b,b=""),h&&(o.push(h),h=""),o.push({name:$||l++,prefix:b,suffix:"",pattern:k||s,modifier:c("MODIFIER")||""});continue}var m=p||c("ESCAPED_CHAR");if(m){h+=m;continue}h&&(o.push(h),h="");var N=c("OPEN");if(N){var b=f(),H=c("NAME")||"",u=c("PATTERN")||"",w=f();d("CLOSE"),o.push({name:H||(u?l++:""),pattern:H&&!u?s:u,prefix:b,suffix:w,modifier:c("MODIFIER")||""});continue}d("END")}return o}function at(n,e){var t=[],i=Me(n,t,e);return lt(i,t,e)}function lt(n,e,t){t===void 0&&(t={});var i=t.decode,r=i===void 0?function(s){return s}:i;return function(s){var o=n.exec(s);if(!o)return!1;for(var l=o[0],a=o.index,h=Object.create(null),c=function(f){if(o[f]===void 0)return"continue";var p=e[f-1];p.modifier==="*"||p.modifier==="+"?h[p.name]=o[f].split(p.prefix+p.suffix).map(function($){return r($,p)}):h[p.name]=r(o[f],p)},d=1;d<o.length;d++)c(d);return{path:l,index:a,params:h}}}function M(n){return n.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function Re(n){return n&&n.sensitive?"":"i"}function ct(n,e){if(!e)return n;for(var t=/\((?:\?<(.*?)>)?(?!\?)/g,i=0,r=t.exec(n.source);r;)e.push({name:r[1]||i++,prefix:"",suffix:"",modifier:"",pattern:""}),r=t.exec(n.source);return n}function ht(n,e,t){var i=n.map(function(r){return Me(r,e,t).source});return new RegExp("(?:".concat(i.join("|"),")"),Re(t))}function dt(n,e,t){return ut(ot(n,t),e,t)}function ut(n,e,t){t===void 0&&(t={});for(var i=t.strict,r=i===void 0?!1:i,s=t.start,o=s===void 0?!0:s,l=t.end,a=l===void 0?!0:l,h=t.encode,c=h===void 0?function(Q){return Q}:h,d=t.delimiter,f=d===void 0?"/#?":d,p=t.endsWith,$=p===void 0?"":p,k="[".concat(M($),"]|$"),b="[".concat(M(f),"]"),m=o?"^":"",N=0,H=n;N<H.length;N++){var u=H[N];if(typeof u=="string")m+=M(c(u));else{var w=M(c(u.prefix)),v=M(c(u.suffix));if(u.pattern)if(e&&e.push(u),w||v)if(u.modifier==="+"||u.modifier==="*"){var x=u.modifier==="*"?"?":"";m+="(?:".concat(w,"((?:").concat(u.pattern,")(?:").concat(v).concat(w,"(?:").concat(u.pattern,"))*)").concat(v,")").concat(x)}else m+="(?:".concat(w,"(").concat(u.pattern,")").concat(v,")").concat(u.modifier);else u.modifier==="+"||u.modifier==="*"?m+="((?:".concat(u.pattern,")").concat(u.modifier,")"):m+="(".concat(u.pattern,")").concat(u.modifier);else m+="(?:".concat(w).concat(v,")").concat(u.modifier)}}if(a)r||(m+="".concat(b,"?")),m+=t.endsWith?"(?=".concat(k,")"):"$";else{var E=n[n.length-1],G=typeof E=="string"?b.indexOf(E[E.length-1])>-1:E===void 0;r||(m+="(?:".concat(b,"(?=").concat(k,"))?")),G||(m+="(?=".concat(b,"|").concat(k,")"))}return new RegExp(m,Re(t))}function Me(n,e,t){return n instanceof RegExp?ct(n,e):Array.isArray(n)?ht(n,e,t):dt(n,e,t)}var pt=Object.defineProperty,ft=Object.getOwnPropertyDescriptor,ae=(n,e,t,i)=>{for(var r=i>1?void 0:i?ft(e,t):e,s=n.length-1,o;s>=0;s--)(o=n[s])&&(r=(i?o(e,t,r):o(r))||r);return i&&r&&pt(e,t,r),r};async function gt(n){return fetch(n).then(e=>e.json())}var O,we;let W=(we=class extends D{constructor(){super(...arguments);he(this,O,void 0);Z(this,O,"https://konturio.github.io/qgis-uni-navigation/nav-config.json"),this.config=null,this.logo=null}get src(){return ce(this,O)}set src(e){Z(this,O,e)}async connectedCallback(){super.connectedCallback();const e=await gt(this.src);this.config=e,this.getAttribute("data-screen")!=="mobile"&&(this.handleWindowResize(),window.addEventListener("resize",this.handleWindowResize.bind(this)))}disconnectedCallback(){window.removeEventListener("resize",this.handleWindowResize.bind(this)),super.disconnectedCallback()}handleWindowResize(){const{breakpoint:e}=this.config??{};if(!e)return;window.innerWidth<e?this.setAttribute("data-screen","mobile"):(this.removeAttribute("data-screen"),this._handleCloseMobileMenu(),this._handleCloseMobileSubMenus())}drawLogo(){var i;const e=((i=this.config)==null?void 0:i.logo)??null,t=e?`https://konturio.github.io/qgis-uni-navigation/${e.icon}`:"";return e?_`<a class="link logo" style="--logo-img:url('${t}')" href="${e.link}"><div></div></a>`:""}checkActive(e){return e?!!at(e,{decode:decodeURIComponent})(window.location.pathname):!1}drawMenu(e=[],t=!0){return e?_`${e.map(i=>{switch(i.type){case"link":const r=i.settings.href.startsWith("https"),s=ye({link:!0,active:this.checkActive(i.settings.activeTest),external:r});return r?_`<a href="${i.settings.href}" class="${s}" target="_blank" noopener noreferrer>${i.settings.name}</a>`:_`<a href="${i.settings.href}" class="${s}">${i.settings.name}</a>`;case"menu":const o=ye({menu:!0,"top-level":t});return _`<div class="${o}" @click="${this._handleClickMobileSubMenu}"><a class="link">${i.settings.name}</a><div class="dropdown">${this.drawMenu(i.settings.children,!1)}</div></div>`;case"button":return _`<a href="${i.settings.href}" class="link button">${i.settings.name}</a>`;default:return""}})}`:_``}_handleBurgerClick(e){var s;const t=e.currentTarget,i=t.getAttribute("aria-expanded")==="true";t.setAttribute("aria-expanded",(!i).toString()),t.classList.toggle("active");const r=(s=this.shadowRoot)==null?void 0:s.querySelector("#mobile-menu");r&&r.classList.toggle("active")}_handleCloseMobileMenu(){var i,r;const e=(i=this.shadowRoot)==null?void 0:i.querySelector("#mobile-menu");if(!e)return;e.classList.remove("active");const t=(r=this.shadowRoot)==null?void 0:r.querySelector("#burger");t&&(t.classList.remove("active"),t.setAttribute("aria-expanded","false"))}_handleClickMobileSubMenu(e){e.stopPropagation();const t=e.currentTarget,i=t.getAttribute("aria-expanded")==="true";t.setAttribute("aria-expanded",(!i).toString());const r=t.querySelector(".dropdown");if(!r)return;const s=r.getAttribute("data-expanded")==="true";r.setAttribute("data-expanded",(!s).toString())}_handleCloseMobileSubMenus(){var i,r;const e=(i=this.shadowRoot)==null?void 0:i.querySelectorAll(".mobile .menu");e==null||e.forEach(s=>s.setAttribute("aria-expanded","false"));const t=(r=this.shadowRoot)==null?void 0:r.querySelectorAll(".mobile .dropdown");t==null||t.forEach(s=>s.setAttribute("data-expanded","false"))}drawBurger(){return _`<a id="burger" @click="${this._handleBurgerClick}" role="button" class="burger" aria-label="mobile burger menu" aria-expanded="false" data-target="mobile-menu"><span aria-hidden="true"></span> <span aria-hidden="true"></span> <span aria-hidden="true"></span></a>`}drawMobileMenu(){var t;const e=(t=this.config)==null?void 0:t.navigation;return _`<div id="mobile-menu" class="mobile">${this.drawMenu(e,!1)}</div>`}drawHeader(){var t;const e=(t=this.config)==null?void 0:t.navigation;return e?_`<nav class="navigation" role="navigation" aria-label="main navigation">${this.drawLogo()}<div class="desktop">${this.drawMenu(e)}</div>${this.drawBurger()}</nav>`:""}render(){return _`<header class="header">${this.drawHeader()} ${this.drawMobileMenu()}</header>`}},O=new WeakMap,we);W.styles=Oe`
    ...
    .link.external::after {
      content: '';
      mask: url('${re("https://konturio.github.io/qgis-uni-navigation/")}external.svg') no-repeat 50% 50%;
      mask-size: cover;
      width: 1rem;
      height: 1rem;
    ...
    .menu > .link::after {
      content: '';
      mask: url('${re("https://konturio.github.io/qgis-uni-navigation/")}arrow.svg') no-repeat 50% 50%;
      mask-size: cover;
      width: 1rem;
      height: 1rem;
  ...
  `;ae([ke({type:String})],W.prototype,"src",1);ae([tt()],W.prototype,"config",2);W=ae([Ze("qg-top-nav")],W);
