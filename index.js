...
\f\r"'\`<>=]|("|')|))|$)`,"g"),ye=/'/g,Ae=/"/g,Re=/^(?:script|style|textarea|title)$/i,Fe=n=>(e,...t)=>({_$litType$:n,strings:e,values:t}),_=Fe(1),T=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),we=new WeakMap,P=k.createTreeWalker(k,129);function Me(n,e){if(!Array.isArray(n)||!n.hasOwnProperty("raw"))throw Error("invalid template strings array");return $e!==void 0?$e.createHTML(e):e}const Ke=(n,e)=>{const t=n.length-1,i=[];let r,s=e===2?"<svg>":"",o=D;for(let l=0;l<t;l++){const a=n[l];let h,c,d=-1,f=0;for(;f<a.length&&(o.lastIndex=f,c=o.exec(a),c!==null);)f=o.lastIndex,o===D?c[1]==="!--"?o=be:c[1]!==void 0?o=_e:c[2]!==void 0?(Re.test(c[2])&&(r=RegExp("</"+c[2],"g")),o=C):c[3]!==void 0&&(o=C):o===C?c[0]===">"?(o=r??D,d=-1):c[1]===void 0?d=-2:(d=o.lastIndex-c[2].length,h=c[1],o=c[3]===void 0?C:c[3]==='"'?Ae:ye):o===Ae||o===ye?o=C:o===be||o===_e?o=D:(o=C,r=void 0);const p=o===C&&n[l+1].startsWith("/>")?" ":"";s+=o===D?a+We:d>=0?(i.push(h),a.slice(0,d)+Pe+a.slice(d)+y+p):a+y+(d===-2?l:p)}return[Me(n,s+(n[t]||"<?>")+(e===2?"</svg>":"")),i]};class K{constructor({strings:e,_$litType$:t},i){let r;this.parts=[];let s=0,o=0;const l=e.length-1,a=this.parts,[h,c]=Ke(e,t);if(this.el=K.createElement(h,i),P.currentNode=this.el.content,t===2){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(r=P.nextNode())!==null&&a.length<l;){if(r.nodeType===1){if(r.hasAttributes())for(const d of r.getAttributeNames())if(d.endsWith(Pe)){const f=c[o++],p=r.getAttribute(d).split(y),$=/([.?@])?(.*)/.exec(f);a.push({type:1,index:s,name:$[2],strings:p,ctor:$[1]==="."?Je:$[1]==="?"?Ge:$[1]==="@"?Qe:te}),r.removeAttribute(d)}else d.startsWith(y)&&(a.push({type:6,index:s}),r.removeAttribute(d));if(Re.test(r.tagName)){const d=r.textContent.split(y),f=d.length-1;if(f>0){r.textContent=ee?ee.emptyScript:"";for(let p=0;p<f;p++)r.append(d[p],V()),P.nextNode(),a.push({type:2,index:++s});r.append(d[f],V())}}}else if(r.nodeType===8)if(r.data===ke)a.push({type:2,index:s});else{let d=-1;for(;(d=r.data.indexOf(y,d+1))!==-1;)a.push({type:7,index:s}),d+=y.length-1}s++}}static createElement(e,t){const i=k.createElement("template");return i.innerHTML=e,i}}function q(n,e,t=n,i){var o,l;if(e===T)return e;let r=i!==void 0?(o=t._$Co)==null?void 0:o[i]:t._$Cl;const s=F(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==s&&((l=r==null?void 0:r._$AO)==null||l.call(r,!1),s===void 0?r=void 0:(r=new s(n),r._$AT(n,t,i)),i!==void 0?(t._$Co??(t._$Co=[]))[i]=r:t._$Cl=r),r!==void 0&&(e=q(n,r._$AS(n,e.values),r,i)),e}class Ye{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,r=((e==null?void 0:e.creationScope)??k).importNode(t,!0);P.currentNode=r;let s=P.nextNode(),o=0,l=0,a=i[0];for(;a!==void 0;){if(o===a.index){let h;a.type===2?h=new Y(s,s.nextSibling,this,e):a.type===1?h=new a.ctor(s,a.name,a.strings,this,e):a.type===6&&(h=new Ze(s,this,e)),this._$AV.push(h),a=i[++l]}o!==(a==null?void 0:a.index)&&(s=P.nextNode(),o++)}return P.currentNode=k,r}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Y{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,t,i,r){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=r,this._$Cv=(r==null?void 0:r.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=q(this,e,t),F(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==T&&this._(e):e._$litType$!==void 0?this.g(e):e.nodeType!==void 0?this.$(e):Ve(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==g&&F(this._$AH)?this._$AA.nextSibling.data=e:this.$(k.createTextNode(e)),this._$AH=e}g(e){var s;const{values:t,_$litType$:i}=e,r=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=K.createElement(Me(i.h,i.h[0]),this.options)),i);if(((s=this._$AH)==null?void 0:s._$AD)===r)this._$AH.p(t);else{const o=new Ye(r,this),l=o.u(this.options);o.p(t),this.$(l),this._$AH=o}}_$AC(e){let t=we.get(e.strings);return t===void 0&&we.set(e.strings,t=new K(e)),t}T(e){Te(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,r=0;for(const s of e)r===t.length?t.push(i=new Y(this.k(V()),this.k(V()),this,this.options)):i=t[r],i._$AI(s),r++;r<t.length&&(this._$AR(i&&i._$AB.nextSibling,r),t.length=r)}_$AR(e=this._$AA.nextSibling,t){var i;for((i=this._$AP)==null?void 0:i.call(this,!1,!0,t);e&&e!==this._$AB;){const r=e.nextSibling;e.remove(),e=r}}setConnected(e){var t;this._$AM===void 0&&(this._$Cv=e,(t=this._$AP)==null||t.call(this,e))}}class te{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,r,s){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=t,this._$AM=r,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=g}_$AI(e,t=this,i,r){const s=this.strings;let o=!1;if(s===void 0)e=q(this,e,t,0),o=!F(e)||e!==this._$AH&&e!==T,o&&(this._$AH=e);else{const l=e;let a,h;for(e=s[0],a=0;a<s.length-1;a++)h=q(this,l[i+a],t,a),h===T&&(h=this._$AH[a]),o||(o=!F(h)||h!==this._$AH[a]),h===g?e=g:e!==g&&(e+=(h??"")+s[a+1]),this._$AH[a]=h}o&&!r&&this.O(e)}O(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class Je extends te{constructor(){super(...arguments),this.type=3}O(e){this.element[this.name]=e===g?void 0:e}}class Ge extends te{constructor(){super(...arguments),this.type=4}O(e){this.element.toggleAttribute(this.name,!!e&&e!==g)}}class Qe extends te{constructor(e,t,i,r,s){super(e,t,i,r,s),this.type=5}_$AI(e,t=this){if((e=q(this,e,t,0)??g)===T)return;const i=this._$AH,r=e===g&&i!==g||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,s=e!==g&&(i===g||r);r&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t;typeof this._$AH=="function"?this._$AH.call(((t=this.options)==null?void 0:t.host)??this.element,e):this._$AH.handleEvent(e)}}class Ze{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){q(this,e)}}const ae=j.litHtmlPolyfillSupport;ae==null||ae(K,Y),(j.litHtmlVersions??(j.litHtmlVersions=[])).push("3.1.0");const Xe=(n,e,t)=>{const i=(t==null?void 0:t.renderBefore)??e;let r=i._$litPart$;if(r===void 0){const s=(t==null?void 0:t.renderBefore)??null;i._$litPart$=r=new Y(e.insertBefore(V(),s),s,void 0,t??{})}return r._$AI(n),r};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
